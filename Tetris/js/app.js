...
var hScore = 0;
var snd, clear;
snd = new sound("music/tetris.mp3");
clearSnd = new sound("music/clear.wav");
fallSnd = new sound("music/fall.wav");
...
function myTimer() {
    document.getElementById("countScore").innerHTML = countScore;
    countScore++;
}
